...
import com.example.week1project.ui.Tab1.Tab1_1_Fragment
import com.google.android.material.button.MaterialButton

class Tab2_5_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tab2_5, container, false)
        ...
        // Next 버튼 클릭 이벤트
        val nextButton = view.findViewById<MaterialButton>(R.id.nextbutton2_5)
        nextButton.setOnClickListener {
            ...
            // 데이터베이스 업데이트
            val isUpdated = databaseHelper.updateCapsuleDate(capsuleId, date)

            if (isUpdated) {
                Toast.makeText(requireContext(), "캡슐 날짜가 업데이트되었습니다.", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(requireContext(), "캡슐 날짜 업데이트 실패.", Toast.LENGTH_SHORT).show()
            }

            // Tab2_4_Fragment로 이동
            val nextFragment = Tab2_6_Fragment().apply {
